  ...
  return (
    <footer className="relative text-[#2C1810] bg-[#EDE8DC] backdrop-blur-xl border-t border-[#C4B49A]">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="flex items-center space-x-3 mb-4">
              <h2 className="text-2xl mr-5 font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#8B6F47] to-[#A0845C]">
                AI Mock Interview
              </h2>
            </div>
            <p className="text-sm text-[#2C1810] text-center md:text-left max-w-xs">
          ...
          <div className="flex flex-col items-center">
            <h3 className="text-xl font-semibold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#8B6F47] to-[#A0845C]">
              Quick Links
            </h3>
            <div className="flex flex-col space-y-3 text-center">
              {[
                ...
                <a
                  ...
                  className="text-[#2C1810] hover:text-[#2C1810] transition-colors duration-300
                    relative group"
                >
                  <span
                    className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-[#8B6F47] to-[#A0845C]
        ...
        {/* Copyright Section */}
        <div className="mt-12 pt-8 border-t border-[#C4B49A] text-center">
          <p className="text-xs text-[#2C1810]">
            © {new Date().getFullYear()} AI Mock Interview. All rights reserved.
          </p>
          <p className="text-xs text-[#2C1810] mt-2">
            Made with ❤️ by{" "}
            <a
              href="https://linktr.ee/Adi1816"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-clip-text text-transparent bg-gradient-to-r from-[#8B6F47] to-[#A0845C] hover:from-[#8B6F47] hover:to-[#A0845C] transition-all duration-300"
            >
              Aditya Srivastava
            </a>
          </p>
